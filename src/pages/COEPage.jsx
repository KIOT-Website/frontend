                ...
                <div className="flex flex-col lg:flex-row gap-16 items-start">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-4 py-2 bg-[#18357a]/5 rounded-full">
                                ...
                                <span className="text-[10px] font-graphik font-bold text-[#18357a] tracking-[2px]">Statutory Office</span>
                            </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                                    {[
                                        ...
                                        >
                                            ...
                                            <span className="text-[13px] font-graphik font-semibold text-[#18357a] tracking-tight leading-tight group-hover:translate-x-1 transition-transform">{feature.text}</span>
                                        </div>
                                    ))}

                                </div>

                                <p className="text-[14px] font-graphik font-normal text-slate-600 bg-[#f8fafc] p-6 rounded-2xl border-2 border-slate-100 italic leading-relaxed text-justify">
                    ...
                    <div className="lg:w-1/2 w-full">
                        <div className="mb-10 text-center sm:text-left px-6 sm:px-0">
                            ...
                            <p className="text-[10px] font-graphik font-bold text-slate-400 tracking-[4px]">Statutory Committees & Members</p>
                        </div>
                        ...
                        <motion.div 
                            ...
                            className="bg-white rounded-2xl border border-slate-100 shadow-2xl shadow-slate-200/40 overflow-hidden mx-0"
                        >
                            <div className="p-0">
                                    ...
                                    <table className="w-full text-left border-collapse">
                                        <thead>
                                            <tr className="bg-[#18357a]">
                                                <th className="px-3 sm:px-6 py-4 text-[10px] font-graphik font-bold text-white tracking-[1px] sm:tracking-[2px] w-12 sm:w-20 text-center border-r border-white/10">S.No</th>
                                                <th className="px-4 sm:px-8 py-4 text-[10px] font-graphik font-bold text-white tracking-[1px] sm:tracking-[2px] border-r border-white/10">Name of the Staff</th>
                                                <th className="px-3 py-4 text-[10px] font-graphik font-bold text-white tracking-[1px] sm:tracking-[2px] text-center">Designation</th>
                                            </tr>
                                        </thead>
                                                ...
                                                >
                                                    ...
                                                    <td className="px-3 py-4 text-center">
                                                        <div className="inline-flex px-2 sm:px-3 py-1 rounded-lg bg-slate-50 group-hover:bg-[#18357a] group-hover:text-white transition-all">
                                                            <span className="text-[8px] sm:text-[9px] font-graphik font-bold tracking-[1px]">
                                                                {staff.designation}
                                                            </span>
                                                        </div>
                                                    </td>
