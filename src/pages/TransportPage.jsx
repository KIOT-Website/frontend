        ...
        <div className="min-h-screen bg-[#FCFDFD] font-graphik pb-24">
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 relative z-20">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-black text-[#224292] tracking-tight">Campus Transport</h2>
                        <p className="text-[12px] font-black text-[#ffc107] tracking-[2px]">Institutional Fleet & Routes</p>
                    </div>
                </div>
                <div className="relative p-10 bg-white rounded-[2.5rem] border border-slate-100 shadow-2xl shadow-[#224292]/5 overflow-hidden">
                    <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-start">
                        <div className="space-y-6">
                            <div className="inline-flex items-center gap-3 px-4 py-2 bg-[#ffc107]/10 rounded-full">
                                ...
                                <span className="text-[11px] font-black text-[#224292] tracking-widest leading-none">Official KIOT Transport</span>
                            </div>
                            
                            <h2 className="text-4xl font-black text-[#224292] tracking-tight leading-none font-display">
                            ...
                            <div className="pt-6">
                                <Link to="/bus-routes" className="inline-flex items-center gap-4 px-8 py-5 bg-[#224292] rounded-2xl group hover:bg-[#ffc107] transition-all shadow-xl shadow-[#224292]/20">
                                    <Bus size={20} className="text-[#ffc107] group-hover:text-[#224292] transition-colors" />
                                    <span className="text-sm font-black tracking-[2px] text-white group-hover:text-[#224292] transition-colors">
                                        View Bus Routes
                                    </span>
                                </Link>
                            </div>
                        ...
                        <div className="relative rounded-[2rem] overflow-hidden shadow-2xl group border-4 border-white aspect-video">
                            ...
                            />
                            <div className="absolute inset-0 bg-[#224292]/20" />
                        </div>
                    </div>
                </div>
            </div>
