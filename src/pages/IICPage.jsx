            ...
            <section className="py-16 lg:py-24 bg-white border-t border-slate-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-16">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            {['2025-26', '2024-25', '2023-24'].map((year) => (
                                <button
                                    key={year}
                                    onClick={() => { setActiveYear(year); setShowDetails(false); }}
                    ...
                    {(() => {
                        ...
                        const currentData = activitiesData[activeYear] || [];
                        
                        return (
                            <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-3 sm:p-5">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    <div className="flex items-center gap-3">
                                        <div className="w-1.5 h-8 bg-[#224292] rounded-full" />
                                        <div className="text-lg md:text-xl font-black text-[#224292]">
                                            AY {activeYear} <span className="text-[#ffc107]">Summary</span>
                                        </div>
                                    </div>
                                    <button 
                                        onClick={() => setShowDetails(!showDetails)}
                                        className="flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2.5 sm:py-3 bg-[#224292] text-white rounded-xl font-black text-[11px] sm:text-[13px] hover:bg-[#ffc107] hover:text-[#224292] transition-colors shadow-sm w-fit"
                                    >
                                        Total Activities: {currentData.length}
                                        <span className="text-[9px] sm:text-[10px] uppercase tracking-widest opacity-90 border-l border-current pl-2 sm:pl-3 ml-1">
                                            ...
                                            <table className="w-full text-left border-collapse min-w-[600px]">
                                                <thead className="bg-[#224292] text-white">
                                                    <tr>
                                                        ...
                                                        <th className="px-3 sm:px-6 py-3 sm:py-4 font-black text-[11px] sm:text-[12px] uppercase tracking-wider h-12 sm:h-14 whitespace-nowrap text-center w-32">Participants</th>
                                                    </tr>
                                                </thead>
