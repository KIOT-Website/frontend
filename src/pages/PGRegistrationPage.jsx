                ...
                <AnimatePresence mode="wait">
                    {formSubmitted ? (
                        <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-white rounded-[3rem] shadow-2xl p-20 text-center border border-slate-100">
                            <div className="w-24 h-24 bg-[#18357a]/5 rounded-full flex items-center justify-center mx-auto mb-8 shadow-inner">
                                <CheckCircle2 size={56} className="text-[#18357a]" />
                            </div>
                            <h2 className="text-4xl font-black text-[#18357a] uppercase mb-4 tracking-tighter">Enquiry Received</h2>
                            ...
                            <button onClick={() => navigate('/admissions')} className="px-10 py-4 bg-[#18357a] text-white rounded-xl font-black uppercase text-[11px] tracking-widest transition-all">Go Back</button>
                        </motion.div>
                    ) : (
                        <form onSubmit={handleSubmit} className="bg-white rounded-[3rem] shadow-2xl overflow-hidden border border-slate-100">
                            ...
                            <div className="p-10 md:p-16">
                                <div className="flex items-center gap-4 mb-12">
                                    <div className="w-1.5 h-10 bg-[#ffc107] rounded-full" />
                                    <h3 className="text-2xl font-black text-[#18357a] uppercase tracking-tight font-display">Educational Details</h3>
                                </div>
                                <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
                                    <div>
                            ...
                            <div className="p-10 md:p-16 bg-[#18357a]/5">
                                <div className="flex items-center gap-4 mb-12">
                                    <div className="w-1.5 h-10 bg-[#18357a] rounded-full" />
                                    <h3 className="text-2xl font-black text-[#18357a] uppercase tracking-tight font-display">Admission Enquiry</h3>
                                </div>
                                <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
                                    <CustomSelect 
