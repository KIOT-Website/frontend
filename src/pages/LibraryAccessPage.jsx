        ...
        <div className="min-h-screen bg-white font-graphik">
            ...
            <div className="relative pt-6 pb-2 px-6 bg-gradient-to-b from-[#224292]/5 to-transparent overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
                    <motion.h1 
                        ...
                        className="text-3xl md:text-4xl font-semibold text-[#224292] tracking-tight leading-none mb-2"
                    >
            ...
            <div className="max-w-7xl mx-auto px-3 md:px-6 py-6">
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        <div className="p-5 md:p-10 bg-white rounded-2xl border border-slate-100 shadow-2xl shadow-slate-200/40 relative overflow-hidden group hover:border-[#224292]/20 transition-all duration-500">
                             ...
                             <div className="flex items-center gap-4 mb-10 relative z-10">
                                <div className="w-14 h-14 bg-[#224292] rounded-xl flex items-center justify-center text-white shadow-xl shadow-[#224292]/20">
                                    <Library size={28} />
                                </div>
                                <div>
                                    <h2 className="text-xl font-semibold text-[#224292] tracking-tight leading-none">Integrated Library (ILMS)</h2>
                                    <p className="text-xs font-semibold text-[#ffc107] mt-2">As of 13.07.2026</p>
                                </div>
                             </div>
                             ...
                             <div className="grid grid-cols-2 gap-6 mb-10 relative z-10">
                                    ...
                                    { label: 'Implementation', value: 'Since 2009', icon: Globe }
                                     ...
                                     <div key={idx} className="flex gap-4 items-center">
                                         <div className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-[#224292] border border-slate-100">
                                          ...
                                          <div>
                                             <p className="text-xs font-normal text-[#224292] tracking-normal leading-none mb-1">{item.label}</p>
                              ...
                              <div className="p-6 bg-slate-50 rounded-r-xl border-l-4 border-l-black border-y border-r border-slate-100 relative z-10">
                                <p className="text-sm font-normal text-slate-700 leading-relaxed italic">
                        ...
                        <div className="p-5 md:p-10 bg-white rounded-2xl border border-slate-100 shadow-xl shadow-slate-200/20">
                             <div className="flex items-center justify-between mb-8">
                                <h3 className="text-xs font-bold text-[#ffc107] tracking-normal">Salient Features</h3>
                             ...
                             <div className="grid gap-4">
                                {[
                                    ...
                                    <div key={i} className="group p-5 bg-white border border-slate-100 hover:border-[#224292]/20 hover:bg-slate-50/50 rounded-xl transition-all flex items-center">
                    ...
                    >
                        <div className="bg-[#224292] p-4 md:p-12 rounded-2xl text-white shadow-2xl relative overflow-hidden min-h-[600px] flex flex-col border border-[#224292]">
                             ...
                             <div className="relative z-10 flex items-center gap-6 mb-12">
                                <div className="w-16 h-16 bg-[#ffc107] rounded-xl flex items-center justify-center text-[#224292] shadow-[0_15px_40px_rgba(255,193,7,0.4)]">
                                    <Globe size={32} />
                                </div>
                                <div>
                                    <h2 className="text-xl font-bold tracking-normal">Open Access</h2>
                                </div>
                             </div>

                             <div className="relative z-10 flex-1 space-y-10">
                                <div>
                                    <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/10 rounded-full border border-white/20 mb-6 font-semibold text-[10px] tracking-normal text-[#ffc107]">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 relative z-10">
                                        {[
                                            ...
                                            <a 
                                                ...
                                                target="_blank" 
                                                rel="noreferrer" 
                                                className="group px-4 py-3 md:px-6 md:py-4 bg-white/5 hover:bg-white rounded-xl border border-white/10 transition-all flex items-center justify-between shadow-sm"
                                            >
                                                <span className="text-xs xs:text-sm font-semibold tracking-normal text-white group-hover:text-[#224292] transition-colors">{link.n}</span>
                                                <div className="flex items-center gap-2 text-[#ffc107] group-hover:text-[#224292] transition-colors">
                                                    <span className="text-[10px] font-normal tracking-normal hidden sm:block">View</span>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 relative z-10">
                                        {[
                                            ...
                                            <a 
                                                ...
                                                target="_blank" 
                                                rel="noreferrer" 
                                                className="group px-4 py-3 md:px-6 md:py-4 bg-white/5 hover:bg-[#ffc107] rounded-xl border border-white/10 transition-all flex items-center justify-between"
                                            >
                                                <span className="text-xs xs:text-sm font-semibold tracking-normal text-white group-hover:text-[#224292] transition-colors">{link.n}</span>
                                                <div className="flex items-center gap-2 text-[#ffc107] group-hover:text-[#224292] transition-colors">
                                                    <span className="text-[10px] font-normal tracking-normal hidden sm:block">View</span>
