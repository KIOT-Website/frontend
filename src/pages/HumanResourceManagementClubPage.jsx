...
// Import gallery images from assets/club/Human Resource Management Club
import hrImg1 from '../assets/club/Human Resource Management Club/Insight - 280125 (1).jpeg'
import hrImg2 from '../assets/club/Human Resource Management Club/Insight - 280125 (2).jpeg'
import hrImg3 from '../assets/club/Human Resource Management Club/Insight - 280125 (3).jpeg'
import hrImg4 from '../assets/club/Human Resource Management Club/Insight - 280125 (4).jpeg'
import hrImg5 from '../assets/club/Human Resource Management Club/Insight - 280125 (5).jpeg'
import hrImg6 from '../assets/club/Human Resource Management Club/Insight - 280125 (6).jpeg'
import hrImg7 from '../assets/club/Human Resource Management Club/Insight - 280125 (7).jpeg'
import hrImg8 from '../assets/club/Human Resource Management Club/Insight - 280125 (8).jpeg'

export default function HumanResourceManagementClubPage() {
  ...
  const objectives = [
    {
      title: "Comprehensive HR Knowledge",
      desc: "To impart comprehensive knowledge of Human Resource Management concepts such as recruitment, training & development, performance appraisal, and employee relations.",
      icon: BookOpen,
      color: "from-purple-500/10 to-indigo-100/50",
      iconColor: "text-purple-700"
    },
    {
      title: "Industry & Academic Integration",
      desc: "To integrate academic learning with industry practices through expert lectures, workshops, webinars, and corporate interactions.",
      icon: Briefcase,
    ...
    },
    {
      ...
      desc: "To enhance students’ communication, interpersonal, leadership, and conflict-management skills required for HR professionals.",
      icon: HeartHandshake,
      color: "from-rose-500/10 to-pink-100/50",
      iconColor: "text-rose-600"
    },
    {
      title: "Competitions & Professional Certifications",
      desc: "To encourage participation in HR-related projects, certifications, case studies, research activities, and professional competitions.",
      icon: Award,
      color: "from-amber-500/10 to-orange-100/50",
      iconColor: "text-amber-600"
    },
    {
      title: "Ethical Values & Teamwork",
      desc: "To develop ethical values, teamwork, and people-management competencies among student members.",
      icon: ShieldCheck,
  ...
  const galleryImages = [
    { src: hrImg1, title: "Human Resource Management Club - One Day Expert Talk on “Insight” by Dr. Dhanapal" },
    { src: hrImg2, title: "Human Resource Management Club - Expert Address on HR & Workplace Management" },
    { src: hrImg3, title: "Human Resource Management Club - Interactive Student Q&A Session" },
    { src: hrImg4, title: "Human Resource Management Club - Keynote Speaker Felicitation" },
    { src: hrImg5, title: "Human Resource Management Club - Faculty Coordinators & Guest Speaker Presentation" },
    { src: hrImg6, title: "Human Resource Management Club - Student Participants & MBA Attendees" },
    { src: hrImg7, title: "Human Resource Management Club - Group Photo & Valedictory Session" },
    { src: hrImg8, title: "Human Resource Management Club - Workshop Session on HR Skills & Leadership" }
  ]
    ...
    "2024-2025": [
      {
        sno: 1,
        date: "28.01.2025",
        event: "One Day Expert Talk on “Insight”",
        guest: "Dr. Dhanapal\nManaging Trustee and Correspondent\nKovai Vidyashram – A World Class CBSE School, Kangeyam, Tamilnadu",
        participants: 134
      }
    ]
  }
  ...
  const consolidatedReport = [
    { year: "2024 - 2025", count: 1, participants: 134 }
  ]
    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-24 selection:bg-[#ffc107]/20">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-10 relative z-10">
          ...
          >
            ...
            <p className="font-bold tracking-wide uppercase mb-3 text-white/90" style={{ fontSize: 'clamp(0.85rem, 1.8vw, 1.1rem)', letterSpacing: '0.05em' }}>
              People Management, Leadership & Talent Excellence
            </p>
        ...
        >
          <div className="space-y-6">
            ...
            <h2 className="font-extrabold tracking-tight leading-tight" style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.85rem)', color: '#224292' }}>
              Empowering HR Leaders & Real-World Workplace Competencies
            </h2>

            <div className="space-y-4 text-[14px] font-normal text-slate-800 leading-[25.2px] text-justify">
              <p>
                The <strong>Human Resource Management Club</strong> aims to enhance students' knowledge of human resource management and help them apply HR concepts in real-world workplace situations.
              </p>
              <p>
                The club conducts workshops, guest lectures, HR activities, and industry interactions to develop leadership, communication, teamwork, and decision-making skills while preparing students for successful careers in human resource management.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-10 mt-16 mb-8 gallery-section">
        <div className="text-center max-w-2xl mx-auto mb-6 gallery-header">
          ...
          <div className="w-20 h-1.5 rounded-full mx-auto mt-4" style={{ backgroundColor: '#ffc107' }} />
          <p className="mt-4 text-slate-600 font-medium text-sm">Glimpses of expert talks, workshops, and activities of the Human Resource Management Club.</p>
        </div>
          ...
          >
            ...
            <div className="md:w-2/5 p-8 sm:p-10 flex flex-col justify-center bg-white overflow-y-auto">
              <div className="inline-flex items-center gap-1.5 uppercase font-black text-xs mb-4 text-[#224292]">
                ...
                Human Resource Management Event
              </div>
