...
const NonIndexedPublicationsPage = () => {
    ...
    const allPublications = {
        'electronics-&-communication-engineering': [
            ...
            { id: 8, author: "Ms. Elarmathi / Mrs. V.Vadivu S", title: "Soil Nutrients Monitoring and Analyzing System For Agriculture", journal: "International Journal of New Innovations in Engineering and Technology", volume: "Vol 22, Issue 1", issn: "2319-6319", year: "April 2023" },
            { id: 9, author: "Ms. Sasidevi / Mrs. M. Vasanthi S", title: "Intelligent Street Lighting: An IOT Based System for adaptive brightness and fault management", journal: "Journal of IoT in social, Mobile, Analytics and Cloud", volume: "06, 03", issn: "2582–1369", year: "2024" },
            ...
            { id: 11, author: "Mr. Saravanan V", title: "Design And Implementation of Online Grocery Shop", journal: "International Journal of Engineering Research & Technology", volume: "Vol 10, Issue 08", issn: "2278-0181", year: "July 2022" },
            { id: 12, author: "Dr. Shanmugasundaram P", title: "Non-Invasive Quantification of Human Throat Analysis In Endoscopy Scanning Method", journal: "International Journal of Research Publication and Reviews", volume: "Vol 3, Issue 06", issn: "2582-7421", year: "July 2022" },
            { id: 13, author: "Mr. Shanmugasundaram R", title: "Fire and smoke detection without sensors. Image processing based approved.", journal: "International Journal of Engineering Research & Technology", volume: "Vol 10, Issue 08", issn: "2278-0181", year: "July 2022" },
            { id: 14, author: "Mr. Shanmugasundaram R", title: "IoT Based Humidity And Temperature Monitoring System Using Arduino Uno", journal: "International Journal of Engineering Research & Technology", volume: "Vol 10, Issue 08", issn: "2278-0181", year: "July 2022" },
            ...
            { id: 17, author: "Ms. Chitrapaavai L", title: "Hydroponics Irrigation System using IoT", journal: "International Journal of Engineering Research & Technology", volume: "Vol 10, Issue 08", issn: "2278-0181", year: "July 2022" }
        ],
        'civil-engineering': [
            ...
            { id: 5, author: "Dr. Siva Natarajan G", title: "Statistical Analysis for Hydrogeochemical Data Interpretation in Upper Thirumanimuthar Sub Basin, Cauvery River", journal: "Journal of Annamalai University", volume: "Vol.46", issn: "-", year: "2010" },
            { id: 6, author: "Dr. Siva Natarajan G", title: "GIS Study for Locating Village wise Suitable Groundwater Quality Zones in Parts of Veeranam Catchments Area", journal: "Journal of Applied Geochemistry", volume: "Vol.12, No.1", issn: "0972-1967", year: "2009" },
            { id: 7, author: "Dr. Siva Natarajan G", title: "Aquifer Zone Thickness Identification for Artificial Rercharge Studies Through Geophysics in GIS at Upper Manimuktha Sub Basin", journal: "Journal of Geological Association & Research Centre", volume: "Vol.16, No.1", issn: "-", year: "2009" },
            { id: 8, author: "Dr. Siva Natarajan G", title: "Statistical Analysis for Hydrogeochemical Data Interpretation in Upper Thirumanimuthar Sub Basin, Cauvery River", journal: "Journal of Annamalai University", volume: "Vol.46", issn: "-", year: "2010" },
