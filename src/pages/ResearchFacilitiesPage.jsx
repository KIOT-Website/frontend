...
const ResearchFacilitiesPage = () => {
    ...
    const allFacilities = {
        ...
        'electrical-&-electronics-engineering': [
            { id: 1, lab: "E-Mobility Design and Development", equipment: "BLDC Motor Driver spring balance load setup with Hall Sensor (1500W, 48V)", domain: "Electric Vehicle & Powertrain", icon: Cpu },
            { id: 2, lab: "E-Mobility Design and Development", equipment: "SRM Motor Drive with spring balance load setup", domain: "Electric Vehicle & Powertrain", icon: Cpu },
            { id: 3, lab: "E-Mobility Design and Development", equipment: "1 HP Axial Flux SRM Motor", domain: "Electrical Machines", icon: Cpu },
            { id: 4, lab: "E-Mobility Design and Development", equipment: "Three Phase IGBT based power study module", domain: "Power Electronics", icon: Box },
            { id: 5, lab: "E-Mobility Design and Development", equipment: "Lithium Iron Battery Charger setup with BMS 2 KWh / 60V", domain: "Battery Storage & BMS", icon: HardHat },
            { id: 6, lab: "E-Mobility Design and Development", equipment: "FPGA (VPE Spartan 6 board)", domain: "Embedded & Control Systems", icon: Box },
            { id: 7, lab: "E-Mobility Design and Development", equipment: "Battery Hi-Tester with Test Probes & Temperature Probe", domain: "Testing & Instrumentation", icon: Microscope },
            { id: 8, lab: "E-Mobility Design and Development", equipment: "Digital Storage Oscilloscope 400MHZ, 4 Channel", domain: "Testing & Measurement", icon: FlaskConical },
            { id: 9, lab: "E-Mobility Design and Development", equipment: "Electric Test Bench Model Research and Development Work", domain: "E-Mobility R&D", icon: FlaskConical },
            { id: 10, lab: "E-Mobility Design and Development", equipment: "Fluke Energy Meter - 1773 Digital Meter", domain: "Power Quality & Measurement", icon: Box },
            { id: 11, lab: "Renewable Energy Laboratory", equipment: "1kWp Solar PV System", domain: "Solar Energy", icon: HardHat },
            { id: 12, lab: "Renewable Energy Laboratory", equipment: "Micro Wind Energy Generator", domain: "Wind Energy", icon: Cpu },
            { id: 13, lab: "Renewable Energy Laboratory", equipment: "Hybrid (Solar-Wind) Power System", domain: "Hybrid Renewable Systems", icon: Box },
            { id: 14, lab: "Renewable Energy Laboratory", equipment: "Solar PV Emulator", domain: "Solar PV Modeling & Testing", icon: FlaskConical }
        ],
