        ...
        <div className="min-h-screen bg-[#FCFDFD] font-graphik pb-24">
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 relative z-20">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-black text-[#18357a] uppercase tracking-tight">Smart Classrooms</h2>
                        <p className="text-[9px] font-black text-[#ffc107] uppercase tracking-[3px]">Digital Learning Ecosystem</p>
                    </div>
                </div>
