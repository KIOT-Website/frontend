        ...
        <div className="min-h-screen bg-[#FCFDFD] pb-24">
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 relative z-20">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-black text-[#18357a] tracking-tight">Campus Tour</h2>
                ...
                <div className="p-12 bg-white rounded-[2.5rem] border border-slate-100 shadow-2xl shadow-[#18357a]/5 text-center">
                    <div className="inline-flex items-center gap-3 px-4 py-2 bg-[#18357a]/5 rounded-full mb-8">
                        ...
                        <span className="text-xs font-black text-[#18357a] uppercase tracking-widest leading-none">Virtual Experience</span>
                    </div>
                    <h2 className="text-4xl font-black text-[#18357a] tracking-tight leading-none mb-6">
                    ...
                    <div className="max-w-2xl mx-auto space-y-8">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col items-center gap-2">
                                ...
                                <span className="text-xs font-black text-[#18357a] uppercase tracking-widest">VR Ready</span>
                            </div>
                            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col items-center gap-2">
                                ...
                                <span className="text-xs font-black text-[#18357a] uppercase tracking-widest">Guided Info</span>
                            </div>
                            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col items-center gap-2">
                                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-[#18357a] shadow-md"><Compass size={20} /></div>
                                <span className="text-xs font-black text-[#18357a] uppercase tracking-widest">Multi-View</span>
                            </div>
                        </div>
                    </div>
                </div>
