        ...
        <div className="min-h-screen bg-[#FCFDFD] font-graphik pb-24">
            ...
            <div className="relative h-[50vh] flex items-center justify-center overflow-hidden bg-[#18357a]">
                <div className="absolute inset-0">
                    <img 
                        src={campusLifeImg} 
                        className="w-full h-full object-cover object-center opacity-50 scale-110 transition-transform duration-1000" 
                        alt="Student Life"
                    />
                ...
                <div className="relative z-10 text-center px-6">
                    ...
                    >
                        ...
                        <p className="text-white/80 font-medium text-xs md:text-sm max-w-2xl mx-auto uppercase tracking-widest leading-loose">
            ...
            <div className="max-w-7xl mx-auto px-6 py-20 relative z-20">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#18357a]/5 border border-[#18357a]/10 text-[#18357a] text-[10px] font-black uppercase tracking-widest mb-4">
                        <Sparkles size={14} />
                        <span>The KIOT Experience</span>
                    </div>
                    <h2 className="text-3xl md:text-5xl font-black text-[#18357a] uppercase tracking-tighter leading-[1.1]">
                        EMBRACING A <span className="text-[#ffc107]">DYNAMIC ACADEMIC</span> ECOSYSTEM
                    </h2>
                    <p className="text-lg md:text-xl font-bold text-black/70 leading-relaxed text-justify md:text-center">
