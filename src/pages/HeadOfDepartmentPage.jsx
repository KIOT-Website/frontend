  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-graphik flex flex-col items-center justify-center p-6 text-center">
      <motion.div
        ...
        className="max-w-xl"
      >
        <div className="w-24 h-24 rounded-full bg-[#18357a]/5 flex items-center justify-center text-[#18357a] mx-auto mb-8 animate-bounce">
          <Hammer size={48} />
        </div>
        <h1 className="text-4xl md:text-5xl font-black text-[#18357a] mb-6 tracking-tight">
        ...
        <div className="mt-12 flex justify-center items-center gap-2">
          ...
          <div className="w-12 h-1 bg-[#18357a]/10 rounded-full" />
          <div className="w-2 h-2 rounded-full bg-[#ffc107]" />
        </div>
      </motion.div>
    </div>
