...
// Import gallery images from assets/club/Smart Operations and Logistics club
import opsImg1 from '../assets/club/Smart Operations and Logistics club/EIP-2711 (1).jpg'
import opsImg2 from '../assets/club/Smart Operations and Logistics club/EIP-2711 (2).jpg'
import opsImg3 from '../assets/club/Smart Operations and Logistics club/EIP-2711 (3).jpg'
import opsImg4 from '../assets/club/Smart Operations and Logistics club/EIP-2711 (4).jpg'
import opsImg5 from '../assets/club/Smart Operations and Logistics club/EIP-2711 (5).jpg'
import opsImg6 from '../assets/club/Smart Operations and Logistics club/EIP-2711 (6).jpg'
import opsImg7 from '../assets/club/Smart Operations and Logistics club/EIP-2711 (7).jpg'
import opsImg8 from '../assets/club/Smart Operations and Logistics club/EIP-2711 (8).jpg'
import opsImg9 from '../assets/club/Smart Operations and Logistics club/EIP-2711 (9).jpg'

export default function SmartOperationsLogisticsClubPage() {
  ...
  const objectives = [
    {
      title: "Practical Operations & Supply Chain Knowledge",
      desc: "Aims to provide students with practical knowledge in the fields of operations management, logistics, and supply chain management.",
      icon: Package,
      color: "from-sky-500/10 to-blue-100/50",
      iconColor: "text-sky-700"
    },
    {
      title: "Industry Integration & Expert Lectures",
      desc: "Seeks to bridge the gap between academic learning and real-world application by organizing workshops, industrial visits, and guest lectures.",
      icon: Truck,
      color: "from-blue-500/10 to-indigo-100/50",
      iconColor: "text-[#224292]"
    },
    {
      title: "Collaborative Project & Problem Solving",
      desc: "Fosters a community where students collaborate on projects, discuss current trends, and develop innovative solutions to contemporary challenges in logistics.",
      icon: Lightbulb,
  ...
  const galleryImages = [
    { src: opsImg1, title: "Smart Operations and Logistics Club - Expert Talk on Supply Chain & Logistics Business" },
    { src: opsImg2, title: "Smart Operations and Logistics Club - Guest Lecture by Mr. R. Nedumaran (Proprietor – RR Trans)" },
    { src: opsImg3, title: "Smart Operations and Logistics Club - Interactive Student Discussion Session" },
    { src: opsImg4, title: "Smart Operations and Logistics Club - Keynote Speaker Address" },
    { src: opsImg5, title: "Smart Operations and Logistics Club - Guest Speaker Honor & Memento Presentation" },
    { src: opsImg6, title: "Smart Operations and Logistics Club - Faculty & Student Coordinator Team" },
    { src: opsImg7, title: "Smart Operations and Logistics Club - Logistics Business Founder Perspective Presentation" },
    { src: opsImg8, title: "Smart Operations and Logistics Club - MBA Student Audience Attendance" },
    { src: opsImg9, title: "Smart Operations and Logistics Club - Event Valedictory & Group Photo" }
  ]
    ...
    "2024-2025": [
      {
        sno: 1,
        date: "27.11.2024",
        event: "Trends and challenges of supply chain and logistics business – Lessons from a founder perspective",
        guest: "Mr. R. Nedumaran\nProprietor – RR Trans, Vazhapadi.",
        participants: 95
      }
    ]
  }
  ...
  const consolidatedReport = [
    { year: "2024 - 2025", count: 1, participants: 95 }
  ]
    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-24 selection:bg-[#ffc107]/20">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-10 relative z-10">
          ...
          >
            ...
            <h1 className="font-black tracking-tight leading-none mb-3 text-[#ffc107]" style={{ fontSize: 'clamp(1.8rem, 4.5vw, 2.8rem)' }}>
              Smart Operations and Logistics Club
            </h1>
        ...
        >
          <div className="space-y-6">
            ...
            <h2 className="font-extrabold tracking-tight leading-tight" style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.85rem)', color: '#224292' }}>
              Enhancing Practical Knowledge in Supply Chain & Operations Management
            </h2>

            <div className="space-y-4 text-[14px] font-normal text-slate-800 leading-[25.2px] text-justify">
              <p>
                The <strong>Smart Operations and Logistics Club</strong> aims to enhance MBA students' knowledge and practical skills in operations, logistics, and supply chain management through experiential learning.
              </p>
              <p>
                The club serves as a platform to bridge the gap between academic concepts and industry practices by organizing workshops, guest lectures, industrial visits, case study discussions, simulations, and certification programs. It fosters innovation, analytical thinking, teamwork, and leadership while preparing students to address contemporary business challenges and build successful careers in operations, logistics, and supply chain management.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-10 mt-16 mb-8 gallery-section">
        <div className="text-center max-w-2xl mx-auto mb-6 gallery-header">
          ...
          <div className="w-20 h-1.5 rounded-full mx-auto mt-4" style={{ backgroundColor: '#ffc107' }} />
          <p className="mt-4 text-slate-600 font-medium text-sm">Glimpses of expert talks, workshops, and activities of the Smart Operations and Logistics Club.</p>
        </div>
          ...
          >
            ...
            <div className="md:w-2/5 p-8 sm:p-10 flex flex-col justify-center bg-white overflow-y-auto">
              <div className="inline-flex items-center gap-1.5 uppercase font-black text-xs mb-4 text-[#224292]">
                ...
                Smart Operations & Logistics Event
              </div>
