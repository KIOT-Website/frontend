...
const NewsEventsPage = () => {
    ...
    const tabs = [
        ...
        { name: 'Recent Events', icon: Calendar },
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFF]">
            {/* ─── HERO SECTION ─── */}
            <div className="relative h-[45vh] flex items-center overflow-hidden bg-[#224292]">
                <div className="absolute inset-0">
                    <img 
                        ...
                        alt="Campus"
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-[#224292] via-[#224292]/80 to-transparent" />
                </div>
                        ...
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`flex items-center gap-3 px-6 py-3 rounded-xl transition-all duration-300 font-black text-sm tracking-widest ${
                                    activeTab === tab.name 
                                    ? 'bg-[#224292] text-[#ffc107] shadow-lg' 
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="grid lg:grid-cols-[1.8fr_1fr] gap-12">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center justify-between mb-2">
                            <h2 className="text-3xl font-black text-[#224292] tracking-tight">Latest News</h2>
                            <button className="flex items-center gap-2 text-sm font-black text-[#224292] hover:text-[#224292] tracking-widest transition-colors group uppercase">
                            ...
                            {newsData.length > 0 ? newsData.map((news) => (
                                ...
                                >
                                    <div className="md:w-56 h-48 md:h-auto overflow-hidden relative">
                                        ...
                                        <div className="absolute top-4 left-4 bg-[#ffc107] px-3 py-1.5 rounded-lg text-[#224292] text-xs font-black tracking-widest">
                                            {news.category}
                                        </div>
                                    </div>
                                    <div className="flex-1 p-6 flex justify-between items-center">
                                        <div className="space-y-3">
                                            <h3 className="text-2xl font-black text-[#224292] leading-tight group-hover:text-blue-600 transition-colors">{news.title}</h3>
                                        ...
                                        <div className="bg-slate-50 p-5 rounded-2xl flex flex-col items-center justify-center min-w-[100px] border border-slate-100">
                                            ...
                                            <span className="text-3xl font-black text-[#224292] leading-none my-1">{news.date.split(' ')[1].replace(',', '')}</span>
                                ...
                                <div className="bg-white p-12 rounded-[2.5rem] border-2 border-dashed border-slate-100 flex flex-col items-center justify-center text-center space-y-4">
                                    ...
                                    <div>
                                        <p className="text-xl font-black text-[#224292]">No News Posted Yet</p>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center justify-between mb-2">
                                <h2 className="text-3xl font-black text-[#224292] tracking-tight">Recent Events</h2>
                                <button className="flex items-center gap-2 text-sm font-black text-[#224292] hover:text-[#224292] tracking-widest transition-colors group uppercase">
                                ...
                                {eventsData.length > 0 ? eventsData.map((event) => (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <h3 className="text-xl font-black text-[#224292] leading-tight group-hover:text-blue-600 transition-colors">{event.title}</h3>
                                    ...
                                    <div className="bg-white p-8 rounded-2xl border border-dashed border-slate-100 text-center">
                                        <p className="text-slate-400 font-bold">Stay tuned for recent events!</p>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-[0_30px_70px_rgba(10,26,63,0.05)] border border-slate-100 relative overflow-hidden">
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center text-[#224292] shadow-sm">
                                    <Megaphone size={24} />
                                </div>
                                <h3 className="text-2xl font-black text-[#224292] tracking-tight">Announcements</h3>
                            </div>
                                ...
                                {announcements.length > 0 ? announcements.map((ann, i) => (
                                    <div key={i} className="flex gap-4 group cursor-pointer">
                                        ...
                                        <div className="space-y-1">
                                            <p className="text-base font-bold text-slate-800 leading-snug group-hover:text-[#224292] transition-colors">
                                                {ann.text}
                                                {ann.isNew && (
                                                    <span className="ml-2 bg-[#ffc107] text-[#224292] text-[10px] font-black px-2 py-0.5 rounded-md">NEW</span>
                                                )}
                                            </p>
                                        </div>
                                    </div>
                ...
                <div className="mt-24 space-y-10">
                    <div className="flex items-center justify-between">
                        <h2 className="text-4xl font-black text-[#224292] tracking-tight">Event Gallery</h2>
                        <button className="flex items-center gap-2 text-sm font-black text-[#224292] hover:text-[#224292] tracking-widest transition-colors group uppercase">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {galleryData.length > 0 ? galleryData.map((item, i) => (
                            ...
                            >
                                ...
                                <h4 className="text-base font-black text-[#224292] text-center px-4 leading-tight">{item.title}</h4>
                            </motion.div>
                        )) : (
            ...
            {/* ─── FOOTER BANNER ─── */}
            <div className="bg-[#224292] py-24 mt-12 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 relative z-10 text-center space-y-12">
                    ...
                    <div className="flex flex-col md:flex-row max-w-2xl mx-auto items-center gap-4">
                        <input 
                            ...
                            className="bg-white border border-white rounded-2xl px-8 py-5 text-[#224292] w-full outline-none font-bold shadow-2xl"
                        />
                        <button className="bg-[#ffc107] text-[#224292] px-12 py-5 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-white transition-all shadow-2xl w-full md:w-auto shrink-0">
                            Subscribe
                        </button>
                    </div>
                </div>
