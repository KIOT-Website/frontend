export const cseStudentAchievements = [
...
export const cseFacultyAchievements = [
  {
    sno: 1,
    name: 'Dr. P. Rajendran\nProfessor & Director PAT(III)',
    event: 'Book Chapter',
    level: 'International',
    award: 'Protek Publications',
    title: 'An Investigation on Key Finding, Achievement, and Practical, Application of Blue Brain Technology'
  },
  {
    sno: 2,
    name: 'Mr. T. Karthikeyan\nAssistant Professor',
    event: 'Conference Paper Publication',
    level: 'International',
    award: 'Scopus',
    title: 'A Flexible Multi-Task Sructure Contextual Modality Attention based Emotion Recognition'
  },
  {
    sno: 3,
    ...
    level: 'International',
    award: 'Protek Publications',
    title: 'Arduino Based Driving License Monitoring Using Finger Print'
  },
  {
    sno: 4,
    name: 'Dr. P. Vijayalakshmi\nAssociate Professor',
    event: 'Journal Paper Publication',
    level: 'International',
    award: 'SCIE & Scopus',
    title: 'Adaptive Latent space dip clustering and few-shot wavelet learning for android malware detection'
  },
  {
    sno: 5,
    name: 'Mr. P. Sasikumar\nAssistant Professor',
  ...
  },
  {
    ...
    level: 'International',
    award: 'Protek Publications',
    title: 'Basics of Wireless Communication Systems and Cellular System Design'
  },
  {
    sno: 8,
    name: 'Mrs. N. Subha\nAssistant Professor',
    ...
    level: 'International',
    award: 'Scopus',
    title: 'Dynamic Detection of Fishing Attack in a Reside Website using Machine Learning'
  },
  {
    sno: 9,
    name: 'Mrs. D. Ramya\nAssistant Professor',
  ...
  {
    sno: 10,
    name: 'Mrs. V. Sathiya Priya\nAssistant Professor',
    event: 'Journal Paper Publication',
    level: 'International',
    award: 'Scopus',
    title: 'Facial Recognition Enabled Smart Security Lock System Using Machine Learning Approach'
  },
  {
    sno: 11,
    name: 'Mrs. V. Sathiya Priya\nAssistant Professor',
    ...
    level: 'International',
    award: 'Scopus',
    title: 'Dynamic Resource Allocation in Edge Computing via Deep Deterministic Policy Gradient Reinforcement Learning'
  },
  {
    sno: 12,
    name: 'Mrs. G. Eswari @ Petchiammal\nAssistant Professor',
    event: 'Conference Paper Publication',
    level: 'International',
    award: 'Scopus',
    title: 'A Flexible Multi-Task Sructure Contextual Modality Attention based Emotion Recognition'
  },
  {
    ...
    level: 'International',
    award: 'Scopus',
    title: 'Behavior-Aware Insider Threat Detection in Cloud Systems using a Zero-Trust LSTM Model with Fuzzy Trust Assessment'
  },
  {
    sno: 14,
    name: 'Mrs. G. Eswari @ Petchiammal\nAssistant Professor',
    ...
    level: 'International',
    award: 'Scopus',
    title: 'Graph Reinforcement Learning for Scalable Zero-Day Behavoral Intrusion Detection in Social Networks'
  },
  {
    sno: 15,
    name: 'Mrs. S. Sowndarya\nAssistant Professor',
    event: 'Book Chapter',
    level: 'International',
    award: 'Protek Publications',
    title: 'An Investigation on Key Finding, Achievement, and Practical, Application of Blue Brain Technology'
  ...
  },
  {
    ...
    level: 'Coimbatore',
    award: 'Sakthi Auto',
    title: 'Solve for Sakthi Web Portal'
  },
  {
    sno: 18,
    name: 'Mr. K. Praveen\nAssistant Professor\nMr. S. Walter Vetrivel\nAssistant Professor',
    event: 'Consultancy',
    level: 'Coimbatore',
    award: 'Sakthi Auto',
    title: 'Solve for OHC Web Portal'
  }
];

export const cseStudentAwards = [
