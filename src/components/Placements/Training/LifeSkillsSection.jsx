    ...
    <div className="max-w-7xl mx-auto px-6 mb-12 font-graphik">
      ...
      <div className="mb-10">
        <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-slate-50 border border-slate-100 mb-6">
           <Heart size={14} className="text-[#224292]" />
           <span className="text-[10px] font-bold text-[#224292]">Personal Excellence</span>
        </div>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
           <div className="lg:col-span-1 flex items-center gap-5 px-6 border-r border-slate-100">
              <div className="w-14 h-14 rounded-2xl bg-[#ffc107] flex items-center justify-center text-[#224292] shrink-0 shadow-lg shadow-[#ffc107]/20">
                 <Trophy size={28} />
              </div>
              <div>
           ...
           <div className="lg:col-span-4 grid sm:grid-cols-2 xl:grid-cols-4 gap-6 px-4">
              {benefits.map((benefit, i) => (
                <div key={i} className="flex items-center gap-4 group">
                   <div className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-black shrink-0 border border-slate-100 group-hover:bg-[#224292] group-hover:text-white transition-all duration-300">
