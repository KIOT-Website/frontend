      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2.5 px-5 py-1.5 rounded-full bg-[#18357a]/5 border border-[#18357a]/10 shadow-sm mb-6 w-fit">
             <Settings size={14} className="text-[#18357a]" />
             <span className="text-[10px] font-bold text-[#18357a] uppercase tracking-[0.1em]">Placement Ecosystem</span>
          </div>
        ...
        >
          <div className="absolute top-0 right-0 w-48 h-48 bg-[#18357a]/5 rounded-full -mr-24 -mt-24 blur-3xl opacity-50 transition-all group-hover:bg-[#ffc107]/10" />
          <div className="relative rounded-2xl overflow-hidden border-4 border-white shadow-2xl shadow-black/10 transition-all duration-700">
             ...
             />
             <div className="absolute inset-0 bg-gradient-to-tr from-[#18357a]/30 via-transparent to-transparent" />
             ...
             <div className="absolute bottom-6 right-6 p-5 bg-white/95 backdrop-blur-md rounded-2xl border border-white shadow-xl">
                <div className="flex items-center gap-4">
                   <div className="w-12 h-12 rounded-full bg-[#18357a] text-[#ffc107] flex items-center justify-center shadow-lg"><Users size={22} /></div>
                   <div>
