  ...
  return (
    <>
        ...
        <div className="bg-white rounded-[2rem] p-12 md:p-20 shadow-xl shadow-slate-200/50 border border-[#D5E2F4]/50 flex flex-col md:flex-row gap-16 md:items-center relative overflow-hidden">
          <div className="md:w-5/12 relative z-10">
            <div className="flex items-center gap-2 mb-4">
              <div className="h-px w-8 bg-[#18357a]" />
          ...
          <div className="md:w-7/12 flex flex-wrap gap-4 relative z-10">
            {[
              ...
              <motion.div 
                  ...
                  className="px-8 py-5 rounded-xl border border-[#18357a]/10 bg-white text-xs font-black uppercase tracking-widest text-[#18357a] hover:bg-[#18357a] hover:text-white transition-all cursor-default shadow-sm"
              >
                {model}
              </motion.div>
            ))}
      ...
      <div className="text-center">
        <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} className="inline-block px-12 py-6 rounded-2xl bg-[#18357a] text-white shadow-xl relative group overflow-hidden">
