...
export const btechAidsData = {
  name: 'B.Tech Artificial Intelligence & Data Science',
    ...
    faculty: [
      ...
      { name: 'Mr. Gopalakrishnan A', designation: 'Assistant Professor', doj: '05.07.2021', qualification: 'B.E., M.E.', association: 'Regular', experience: '13 Yrs 9 Months', specialization: 'Operating System, Cloud Computing', email: 'agaids@kiot.ac.in', publications: 'IJ:03,IC:05,NC:03', rating: 4.8, image: aidsGopalakrishnanImage },
      { name: 'Dr. Gomathi A', designation: 'Associate Professor', doj: '04.07.2022', qualification: 'B.E., M.E., Ph.D.', association: 'Regular', experience: 'Teaching: 14 Years (Engg) , 4yrs (poly)', specialization: 'Information Retrieval', email: 'agit@kiot.ac.in', publications: 'IJ:06, NJ:01, IC:6', rating: 4.9, image: aidsGomathiImage },
      { name: 'Ms. Brindha V', designation: 'Assistant Professor', doj: '04.07.2022', qualification: 'B.E., M.E(CSE)', association: 'Regular', experience: '4 Yrs 7 Months', specialization: 'AI & Data Science', email: 'vbaids@kiot.ac.in', rating: 4.6 },
      { name: 'Ms. Esther Rani P J', designation: 'Assistant professor', doj: '07.06.2023', qualification: 'B.E., M.TECH(IT)', association: 'Regular', experience: '6 Yrs 10 Months', specialization: 'Mobile Adhoc network', email: 'pjeraids@kiot.ac.in', publications: 'IJ:2, NJ:1', rating: 4.7, image: aidsEstherRaniImage },
      { name: 'Mr. Jayaprakash S', designation: 'Assistant professor', doj: '01.06.2023', qualification: 'B.E., M.E(CSE)', association: 'Regular', experience: '4 Yrs 7 Months', specialization: 'Computer Networks, Python Programming', email: 'sjaids@kiot.ac.in', publications: 'IJ:2, NJ:2', rating: 4.6, image: aidsJayaprakashImage },
      { name: 'Ms. Bhuvaneswari B', designation: 'Assistant professor', doj: '13.07.2023', qualification: 'B.TECH(IT).,M.TECH(IT)', association: 'Regular', experience: '9 Yrs 11 Months', specialization: 'DSA, Datawarehousing and Data Mining', email: 'bbaids@kiot.ac.in', publications: 'IJ:04 IC:05 NC:05', rating: 4.8, image: aidsBhuvaneswariImage },
      { name: 'Ms. Sudha S', designation: 'Assistant professor', doj: '01.07.2024', qualification: 'B.E., M.E.', association: 'Regular', experience: '4 Yrs 4 Months', specialization: 'Computer Architecture, Big Data Analytics', email: 'ssaids@kiot.ac.in', publications: 'NJ:3', rating: 4.5, image: aidsSudhaImage },
      { name: 'Mr. Rameshkumar R', designation: 'Assistant professor', doj: '08.07.2024', qualification: 'B.E., M.E.', association: 'Regular', experience: '7 Yrs 7 Months', specialization: 'Data Structure', email: 'rraids@kiot.ac.in', rating: 4.6, image: aidsRameshkumarImage },
      ...
      { name: 'Ms. Deepa M', designation: 'Assistant professor', doj: '04.09.2024', qualification: 'M.E(Ph.D)', association: 'Regular', experience: '8 Yrs 9 Months', specialization: 'Computer Networks', email: 'deepapec693@gmail.com', publications: 'NJ:2', rating: 4.6, image: aidsDeepaImage },
      ...
      { name: 'Dr. Manivel S', designation: 'Assistant professor', doj: '20.06.2024', qualification: 'M.sc., Ph.D.', association: 'Regular', experience: '9 Yrs 10 Months', specialization: 'vibrational spectroscopy', email: 'smvphy@kiot.ac.in', publications: 'IJ:6, NJ:6', rating: 4.7, image: aidsManivelImage },
      ...
      { name: 'Ms. Rupa Devi M', designation: 'Assistant Professor', doj: '04.05.2026', qualification: 'M.E.(CSE)', association: 'Regular', experience: 'Teaching – 6 Months', specialization: 'Machine Learning', email: 'mraids@kiot.ac.in', publications: 'SIJ: 2', rating: 4.6 },
      { name: 'Ms. Mugambigai S', designation: 'Assistant Professor', doj: '13.05.2026', qualification: 'M.E.(CSE)', association: 'Regular', experience: '-', specialization: 'Image Processing', email: 'smaids@kiot.ac.in', publications: 'SIJ: 1', rating: 4.5 },
      { name: 'Ms. Savitha N', designation: 'Assistant Professor', doj: '19.05.2026', qualification: 'MCA., ME', association: 'Regular', experience: 'Teaching – 10 Years', specialization: 'AI with IOT', email: 'nsaids@kiot.ac.in', publications: 'SIJ: 2', rating: 4.7 },
      ...
      { name: 'Dr. Venkatesh G', designation: 'Professor/Chemistry', doj: '20.09.2023', qualification: 'M.Sc., M.Phil., Ph.D.', association: 'Regular', experience: '10.6 years, Research: 14.8 yrs', specialization: 'Supramolecular Nano materials', email: 'gvchem@kiot.ac.in', publications: 'IJ: 24, NJ: 04, IC: 05, NC: 14', rating: 5.0, image: aidsVenkateshImage, category: 'S&H' },
      { name: 'Mr. Venkatachalam T', designation: 'Assistant Professor', doj: '16.07.2021', qualification: 'M.A., M.Phil., B.Ed.', association: 'Regular', experience: '12 Yrs 6 Months', specialization: 'Language and Linguistics', email: 'venkatachalamteng@kiot.ac.in', publications: 'IC:01', rating: 4.7, image: aidsVenkatachalamImage, category: 'S&H' },
      { name: 'Ms. Gomathi V', designation: 'Assistant Professor', doj: '26.08.2021', qualification: 'M.Sc., M.Phil.', association: 'Regular', experience: '8 Yrs 4 Months', specialization: 'Differential Equations', email: 'gomathivvs@gmail.com', rating: 4.6, image: aidsGomathiShImage, category: 'S&H' },
      { name: 'Dr. Sathya Priyanka G', designation: 'Assistant Professor / Maths', doj: '09-05-2025', qualification: 'M.Sc., M.Phil., Ph.D.', association: 'Regular', experience: 'Research: 6 Yrs Teaching: 3 Months', specialization: 'Stochastic Processes, Reliability', email: 'gspmat@kiot.ac.in', publications: 'IJ:3, NJ:6', rating: 4.7, image: aidsSathyaPriyankaImage, category: 'S&H' }
    ],
    labs: [
      {
        name: 'AI LAB (D BLOCK)',
