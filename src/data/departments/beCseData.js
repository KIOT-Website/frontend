...
import cseTPalanirajaImage from '../../assets/Faculity/cse/Mr.T.PALANIRAJA.webp'
import cseSManjuImage from '../../assets/Faculity/cse/Mrs.S.MANJU.webp'
import cseKarthikPRImage from '../../assets/Faculity/cse/P.R.Karthik.webp'
import cseRManikandanImage from '../../assets/Faculity/cse/Dr.RMANIKANDAN.webp'
...
export const beCseData = {
  name: 'B.E Computer Science and Engineering',
    ...
    overview: [
      "The Department of Computer Science & Engineering was established in the year 2009 with a vision to offer quality higher education to numerous students and to meet the growing demand for highly qualified specialists in the field. The department's primary goal is to provide the best IT infrastructure, a world-class learning and research environment, adopt industry practices through industry collaborations, and inculcate moral and ethical values. The students' alacrity to learn makes it easier for the industry-trained, experienced faculty to produce top-notch engineers who are recruited by reputed companies all over the world.",
      "The Department offers a UG programme in Computer Science & Engineering and a PG programme in Software Engineering. Students who graduate from these programmes go on not only into engineering careers but also into the fields of Business, Government, and Academia. The department plays a vital role in domains such as Intelligent Game Playing, Mobile Applications, Smart Robots, Cloud Computing, and Data Security.",
      "The department is gifted with young and energetic, committed faculty who are certified through the Faculty Empowerment Workshop conducted by WIPRO MISSION10X and have the best available exposure to the ever-growing horizons of computer science and engineering. This spirit continues to guide the department in every possible way to tailor, shape, and build the finest technocrats. With expertise in diverse fields ranging from Wireless Sensor Networks, Mobile Computing, Quantum Computing, Robotics, Natural Language Processing, Computer Networks, and Big Data to Geographical Information Systems, the department has honed many students to date. The enduring dedication and commitment of the faculty members and students have fuelled quality research publications with citations.",
      "The Department has state-of-the-art infrastructure and computing equipment supported by high-speed Ethernet and wireless networks. The department has signed MOUs with leading corporates such as Oracle Academy, Cisco, Aspire,AWS Academy, MX Techies, Expleo, and HCL Tech for all its software needs, and has made available high-end packages with multiple capabilities. This not only provides a platform for the students but also provides opportunities to build their careers.",
      "Students are provided with various opportunities to develop their professionalism, life-long learning skills, teamwork, and communication skills. Students are encouraged to come up with their own ideas, which are materialized by the department into actual projects with societal impact. Students are also encouraged to publish research articles based on the projects undertaken. The rigorous training that the students undergo makes them worthy professionals with the mental agility and technical skill sets sought after by the IT industry."
    ],
    ...
    faculty: [
      {
        ...
        imageStyle: { transform: 'scale(1.10) translateY(0px)', transformOrigin: 'bottom center' }
      },
      {
      ...
      { name: 'Dr. Lakshaga Jyothi M', vidwanId: '320722', designation: 'Assistant Professor', doj: '22.08.2022', qualification: 'B.E., M.E., Ph.D', association: 'Regular', experience: '2.10 Years, Research: 5', specialization: 'IoT, Deep Learning', email: 'mljcse@kiot.ac.in', publications: 'IJ:3, NJ:1, IC:5, NC:2', rating: 4.7, image: cseMLakshagaJyothiImage },
      ...
      { name: 'Ms. Ashwini B', vidwanId: '613510', designation: 'Assistant Professor', doj: '24.04.2023', qualification: 'B.Tech., M.Tech.', association: 'Regular', experience: 'Teaching: 2, Industry: 5', specialization: 'Computer Networks', email: 'bacse@kiot.ac.in', publications: 'IC: 02', rating: 4.6, image: cseAshwiniBImage },
      { name: 'Mr. Sampath M K', vidwanId: '613503', designation: 'Assistant Professor', doj: '08.06.2023', qualification: 'B.E., M.E', association: 'Regular', experience: '10.2 Years', specialization: 'Human Computer Interaction', email: 'mkscse@kiot.ac.in', publications: 'IJ:3, IC:1, NC:2', rating: 4.6, image: cseMKSampathImage, imageStyle: { transform: 'translateY(8px)' } },
      ...
      { name: 'Mr. Palani Raja T', vidwanId: '613619', designation: 'Assistant Professor', doj: '21.06.2023', qualification: 'B.Tech., M.Tech.', association: 'Regular', experience: 'Teaching: 13.10', specialization: 'Networking', email: 'tprcse@kiot.ac.in', publications: 'IC: 5, NC: 6', rating: 4.7, image: cseTPalanirajaImage },
      ...
      { name: 'Ms. Manju S', vidwanId: '703307', designation: 'Assistant Professor', doj: '6.04.2026', qualification: 'B.E., M.E.,', association: 'Regular', experience: 'Teaching - 3', specialization: 'Cloud Computing, AI', email: 'smcse@kiot.ac.in', publications: 'IC:1, NC:3', rating: 4.5, image: cseSManjuImage },
      ...
      { name: 'Ms. Prabha A', vidwanId: '721442', designation: 'Assistant Professor', doj: '25.06.2026', qualification: 'B.E., M.E.,', association: 'Regular', experience: 'Teaching - 6.7 (Polytechnic-5.7 yrs & Engineering -10 months), Industry - 10', specialization: 'Machine Learning', email: 'aprcse@kiot.ac.in', publications: 'NJ:1, IC:1, Book/BC - 1/1', rating: 4.7, image: cseAPrabhaImage, imageStyle: { transform: 'scale(1.15) translateY(-30px)', transformOrigin: 'top center' } },
      ...
      { name: 'Mr. Aravindan C', vidwanId: '728496', designation: 'Assistant Professor', doj: '01.07.2026', qualification: 'B.E., M.E.,', association: 'Regular', experience: 'Teaching - 10 months, Industry – 5.6', specialization: 'C Programming, Data Structures', email: 'cacse@kiot.ac.in', publications: 'Nil', rating: 4.5, image: cseCAravindanImage, imageStyle: { transform: 'scale(1.20) translateY(-30px) translateX(-15px)', transformOrigin: 'top center' } },
      { name: 'Ms. Sowndharya T', vidwanId: '728529', designation: 'Assistant Professor', image: cseSowndharyaImage, imageStyle: { transform: 'scale(1.20) translateY(-30px)', transformOrigin: 'top center' } },
      ...
      { name: 'Ms. Sudha K', designation: 'Assistant Professor', qualification: 'M.Sc., M.Phil., B.Ed.', experience: '19.11 Years', specialization: 'Differential Equations', email: 'sudharmsc@gmail.com', rating: 4.8, category: 'S&H', image: cseKSudhaImage },
